...
import NftUploadPage from 'components/NftUploadPage'
import NftInfoCheckPage from 'components/NftInfoCheckPage'
import NftPlacePage from 'components/NftPlacePage'
import NftInfoPage from 'components/NftInfoPage'
import NftFilePreview from 'components/NftFilePreview'
import NftFileUpload from 'components/NftFileUpload'
    ...
    return (
      <>
        ...
        <Responsive minWidth={1025} as={React.Fragment}>
          <Switch>
            <Route exact path="/">
              <Redirect to={locations.root()}></Redirect>
            </Route>
            <Route exact path={locations.nftupload()} component={NftUploadPage} />
            <Route exact path={locations.nftinfocheck()} component={NftInfoCheckPage} />
            <Route exact path={locations.nftplace()} component={NftPlacePage} />
            <Route exact path={locations.nftinfo()} component={NftInfoPage} />
            <Route exact path={locations.nftfilepreview()} component={NftFilePreview} />
            <Route exact path={locations.nftfileupload()} component={NftFileUpload} />
            <Route exact path={locations.root()} component={NftFileUpload} />
